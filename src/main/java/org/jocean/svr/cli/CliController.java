...
import org.jocean.svr.cli.cmd.TradeCountCommand;
...
public class CliController {
    ...
    static final EventLoopGroup EPOLL_BOSS_GROUP =
            new EpollEventLoopGroup(1, new DefaultThreadFactory("cli-boss", false));

    static final EventLoopGroup EPOLL_WORKER_GROUP =
            new EpollEventLoopGroup(1, new DefaultThreadFactory("cli-worker", false));
    ...
    public void start() throws InterruptedException {
        ...
        final DomainSocketAddress localAddress = new DomainSocketAddress("./" + OSUtil.getCurrentPid() + ".socket");
